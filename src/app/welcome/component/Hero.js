...
export default function Hero(){
  return (
    <div
      ...
      id="hero"
    >
      <div className="h-full w-full bg-linear-to-b from-transparent to-secondary from-30% flex flex-col 
      md:justify-end justify-center md:items-center items-start gap-5 md:gap-10 sm:px-17 px-10 lg:pt-40 md:pt-25">
        ...
        <div className="flex flex-row gap-5">
          <button className="md:px-10 md:py-4 px-5 py-2 sm:py-3 sm:px-6 bg-secondary hover:bg-primary duration-200 2xl:text-4xl lg:text-2xl md:text-2xl sm:text-sm text-xs rounded-full">
            Start Planning
          </button>
