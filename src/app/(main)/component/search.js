...
export default function Search(){
    return(
        <div className="min-h-screen h-full w-full flex flex-col gap-5 bg-white border-t-2 p-5 py-15 md:p-15 border-secondary" id="search">
            <div className="w-full md:grid grid-cols-2 flex flex-col gap-3 items-center justify-center border-b border-secondary p-3">
                ...
                <div className="w-full md:flex md:flex-row grid grid-cols-2 gap-3 md:items-end items-center justify-evenly md:text-base text-xs">
