        ...
        <div className="h-full grid grid-cols-1 md:grid-cols-12 gap-6 flex-1">
          ...
          <div className="md:col-span-4 space-y-4 flex flex-col h-full">
            <div className="bg-gray-100 rounded-2xl overflow-hidden shadow-sm border border-gray-200 relative grow ">
              ...
              {toko.kontak && (
                ...
                className="absolute bottom-0 inset-x-0 z-20 block w-full p-4 bg-blue-600 text-white text-center font-semibold text-base hover:bg-blue-700 transition duration-150 shadow-lg"
                style={{
          ...
          <div className="md:col-span-8 flex flex-col">
            ...
            <div className="space-y-5 shrink-0 mb-4">
              <div className="p-6 border border-primary rounded-xl">
                <div className="flex justify-between items-start">
                  ...
                  <Heart
                    className="h-6 w-6 text-pink-500 cursor-pointer transition duration-150 hover:scale-110"
                    fill="currentColor"
                    />
                </div>
                    ...
                    <div className="bg-blue-50 rounded-xl p-3">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-semibold text-gray-900">
                          Sumi-sumi |{' '}
                          <span className="text-blue-600">Diskon 40%</span>
                        </span>
                      ...
                      <p className="text-xs text-gray-600">
                        Makanan berbasis Cepat saji
                      </p>
                      <p className="text-xs text-blue-600">
                        + Bebas kirim dari PHO Doraemon
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="p-6 border border-primary rounded-xl flex flex-col">
              ...
              <div className="overflow-y-auto hide-scrollbar flex-1 max-h-[45vh]">
                        ...
                        <div className="grow">
                          <p className="text-gray-600">
                            ...
                            {item.harga_m && item.harga_xl && (
                              <span className="text-blue-600 font-semibold">
                                {' '}
                                - M: {formatPrice(item.harga_m)} / XL:{' '}
                                {formatPrice(item.harga_xl)}
                              </span>
                            )}
                          </p>
